(function(V, _) {
  ...
  function k(e) {
    ...
    if (e.load && e.load.remembered ? d.each(e.load.remembered, function(S, T) {
      F(e, T, T === e.preset);
    }) : F(e, I, !1), l.bind(h, "change", function() {
  ...
  var Me = Array.prototype.forEach, _e = Array.prototype.slice, d = { BREAK: {}, extend: function(e) {
    ...
    function e() {
      if (M(this, e), this.__state = Te.apply(this, arguments), this.__state === !1)
  ...
  var J = /(\d+(\.\d+)?)px/, l = { makeSelectable: function(e, t) {
    ...
    var r = i, u = t;
    d.isUndefined(u) && (u = !0), d.isUndefined(r) && (r = !0), e.style.position = "absolute", u && (e.style.left = 0, e.style.right = 0), r && (e.style.top = 0, e.style.bottom = 0);
    ...
    function t(i, r, u, c, h) {
      function g(R) {
        ...
        return m.setValue(n(R.clientX, q.left, q.right, m.__min, m.__max)), !1;
      }
      function b() {
    ...
    function t(i, r) {
      ...
      function b() {
        var N = Te(this.value);
        N !== !1 ? (R.__color.__state = N, R.setValue(R.__color.toOriginal())) : this.value = R.__color.toString();
      }
      function v() {
      ...
      function S(N) {
        ...
        return xe > 1 ? xe = 1 : xe < 0 && (xe = 0), fe > 1 ? fe = 1 : fe < 0 && (fe = 0), R.__color.v = xe, R.__color.s = fe, R.setValue(R.__color.toOriginal()), !1;
      }
      function T(N) {
        N.type.indexOf("touch") === -1 && N.preventDefault();
...
`);
  ...
  var I = "Default", oe = function() {
    ...
    var i = this, r = t || {};
    this.domElement = document.createElement("div"), this.__ul = document.createElement("ul"), this.domElement.appendChild(this.__ul), l.addClass(this.domElement, "dg"), this.__folders = {}, this.__controllers = [], this.__rememberedObjects = [], this.__rememberedObjectIndecesToControllers = [], this.__listening = [], r = d.defaults(r, { closeOnTop: !1, autoPlace: !0, width: e.DEFAULT_WIDTH }), r = d.defaults(r, { resizable: r.autoPlace, hideable: r.autoPlace }), d.isUndefined(r.load) ? r.load = { preset: I } : r.preset && (r.load.preset = r.preset), d.isUndefined(r.parent) && r.hideable && j.push(this), r.resizable = d.isUndefined(r.parent) && r.resizable, r.autoPlace && d.isUndefined(r.scrollable) && (r.scrollable = !0);
    ...
    if (Object.defineProperties(this, { parent: { get: function() {
      ...
      if (r.closed = !1, l.addClass(this.domElement, e.CLASS_MAIN), l.makeSelectable(this.domElement, !1), oe && u) {
        i.useLocalStorage = !0;
    ...
    r.autoPlace && (d.isUndefined(r.parent) && (ne && (Y = document.createElement("div"), l.addClass(Y, "dg"), l.addClass(Y, e.CLASS_AUTO_PLACE_CONTAINER), document.body.appendChild(Y), ne = !1), Y.appendChild(this.domElement), l.addClass(this.domElement, e.CLASS_AUTO_PLACE)), this.parent || Le(i, r.width)), this.__resizeHandler = function() {
      i.onResizeDebounced();
  ...
  C.toggleHide = function() {
    ...
    d.each(this.__folders, function(t) {
      e.removeFolder(t);
    }), l.unbind(window, "keydown", C._keydownHandler, !1), ke(this);
  ...
  <div id="dg-save-locally">
    ...
    this.load.remembered || (this.load.remembered = {}), this.load.remembered[this.preset] = ye(this), Oe(this, !1), this.saveToLocalStorageIfPossible();
  }, saveAs: function(e) {
    this.load.remembered || (this.load.remembered = {}, this.load.remembered[I] = ye(this, !0)), this.load.remembered[e] = ye(this), this.preset = e, F(this, e, !0), this.saveToLocalStorageIfPossible();
  }, revert: function(e) {
  ...
  V.color = Ge, V.controllers = Xe, V.dom = H, V.gui = Ce, V.GUI = Ve, V.default = Ye, Object.defineProperty(V, "__esModule", { value: !0 });
});
function ft(V, _) {
  const D = V;
  g(), _ = {
  ...
  const eventTarget = _.EVENT_TARGET instanceof EventTarget ? _.EVENT_TARGET : D;
  Oe() && (_.DYE_RESOLUTION = 512), P.supportLinearFiltering || (_.DYE_RESOLUTION = 512, _.SHADING = !1, _.BLOOM = !1, _.SUNRAYS = !1);
  function Ke(o) {
...
`), A = (() => (n.bindBuffer(n.ARRAY_BUFFER, n.createBuffer()), n.bufferData(n.ARRAY_BUFFER, new Float32Array([-1, -1, -1, 1, 1, 1, 1, -1]), n.STATIC_DRAW), n.bindBuffer(n.ELEMENT_ARRAY_BUFFER, n.createBuffer()), n.bufferData(n.ELEMENT_ARRAY_BUFFER, new Uint16Array([0, 1, 2, 0, 2, 3]), n.STATIC_DRAW), n.vertexAttribPointer(0, 2, n.FLOAT, !1, 0, 0), n.enableVertexAttribArray(0), (o) => {
  ...
  let isRunning = !1;
  let idleTimer = null;
  _.ON_DEMAND ? (startRenderLoop(), scheduleIdleStop(_.INITIAL_IDLE_TIMEOUT)) : c();
  function startRenderLoop() {
    isRunning || (isRunning = !0, r = Date.now(), requestAnimationFrame(c));
  }
  function stopRenderLoop() {
    isRunning = !1;
  }
  function scheduleIdleStop(o = _.IDLE_TIMEOUT) {
    _.ON_DEMAND && (idleTimer && window.clearTimeout(idleTimer), idleTimer = window.setTimeout(() => {
      stopRenderLoop();
    }, o));
  }
  function c() {
    if (_.ON_DEMAND && !isRunning)
      return;
    const o = h();
    g() && C(), b(o), v(), _.PAUSED || S(o), T(null), (_.ON_DEMAND ? isRunning : !0) && requestAnimationFrame(c);
  }
  function h() {
    const o = Date.now();
    let s = (o - r) / 1e3;
  ...
  function pt(o, s = D.getBoundingClientRect()) {
    return {
      x: $(o.clientX - s.left),
      y: $(o.clientY - s.top)
    };
  }
  eventTarget.addEventListener("mousedown", (o) => {
    const s = pt(o), a = s.x, f = s.y;
    let p = U.find((w) => w.id === -1);
    p || (p = new he()), it(p, -1, a, f), _.ON_DEMAND && (startRenderLoop(), scheduleIdleStop());
  }), setTimeout(() => {
    eventTarget.addEventListener("mousemove", (o) => {
      const s = pt(o), a = s.x, f = s.y;
      ot(U[0], a, f), _.ON_DEMAND && (startRenderLoop(), scheduleIdleStop());
    });
  }, _.START_DELAY), window.addEventListener("mouseup", () => {
    nt(U[0]);
  }), eventTarget.addEventListener("touchstart", (o) => {
    o.preventDefault();
    const s = o.targetTouches, a = D.getBoundingClientRect();
    for (; s.length >= U.length; )
      U.push(new he());
    for (let f = 0; f < s.length; f++) {
      const p = pt(s[f], a), w = p.x, E = p.y;
      it(U[f + 1], s[f].identifier, w, E);
    }
    _.ON_DEMAND && (startRenderLoop(), scheduleIdleStop());
  }), eventTarget.addEventListener("touchmove", (o) => {
    o.preventDefault();
    const s = o.targetTouches, a = D.getBoundingClientRect();
    for (let f = 0; f < s.length; f++) {
      const p = pt(s[f], a), w = p.x, E = p.y;
    ...
    o.code === "KeyP" && (_.PAUSED = !_.PAUSED), o.key === " " && (me.push(Number.parseInt(Math.random() * 20) + 5), _.ON_DEMAND && (startRenderLoop(), scheduleIdleStop()));
  });
  function it(o, s, a, f) {

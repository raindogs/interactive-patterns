...
`), A = (() => (n.bindBuffer(n.ARRAY_BUFFER, n.createBuffer()), n.bufferData(n.ARRAY_BUFFER, new Float32Array([-1, -1, -1, 1, 1, 1, 1, -1]), n.STATIC_DRAW), n.bindBuffer(n.ELEMENT_ARRAY_BUFFER, n.createBuffer()), n.bufferData(n.ELEMENT_ARRAY_BUFFER, new Uint16Array([0, 1, 2, 0, 2, 3]), n.STATIC_DRAW), n.vertexAttribPointer(0, 2, n.FLOAT, false, 0, 0), n.enableVertexAttribArray(0), (o) => {
    ...
    function startRenderLoop() {
      isRunning || (isRunning = true, r = Date.now(), requestAnimationFrame(c));
    }
    ...
    function c() {
      if (_.ON_DEMAND && !isRunning)
        return;
      const o = h();
      g() && C(), b(o), v(), _.PAUSED || S(o), T(), (_.ON_DEMAND ? isRunning : true) && requestAnimationFrame(c);
    }
    function h() {
      const o = Date.now();
      let s = (o - r) / 1e3;
    ...
    function T(o) {
      _.BLOOM && N(y.read, l), _.SUNRAYS && (X(y.read, y.write, se), Z(se, Fe, 1)), n.blendFunc(n.ONE, n.ONE_MINUS_SRC_ALPHA), n.enable(n.BLEND);
      const s = n.drawingBufferWidth, a = n.drawingBufferHeight;
      n.viewport(0, 0, s, a);
      const f = null;
      _.TRANSPARENT || m(f, lt(_.BACK_COLOR)), _.TRANSPARENT && R(f), q(f, s, a);
    }
    function m(o, s) {
